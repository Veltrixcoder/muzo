...
class StorageService {
  ...
  // App Font
  String get appFontFamily => _settingsBox.get('appFontFamily', defaultValue: 'Karst');
  ...
  // Community Popups
  bool get hasShownTelegramPopup => _settingsBox.get('hasShownTelegramPopup', defaultValue: false);
  Future<void> setHasShownTelegramPopup(bool value) async {
    await _settingsBox.put('hasShownTelegramPopup', value);
  }

  bool get hasShownDiscordPopup => _settingsBox.get('hasShownDiscordPopup', defaultValue: false);
  Future<void> setHasShownDiscordPopup(bool value) async {
