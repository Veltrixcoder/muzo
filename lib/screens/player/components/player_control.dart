                            ...
                            child: BackdropFilter(
                              ...
                              decoration: BoxDecoration(
                                  color: (Theme.of(context).brightness == Brightness.dark
                                      ? Colors.black
                                      : Colors.white).withValues(alpha: Theme.of(context).brightness == Brightness.dark ? 0.20 : 0.35),
                                  border: Border(
                                    top: BorderSide(
                                      color: Colors.white.withValues(alpha: Theme.of(context).brightness == Brightness.dark ? 0.12 : 0.20),
                                      width: 0.75,
                                    ),
                                  ),
                                ),
