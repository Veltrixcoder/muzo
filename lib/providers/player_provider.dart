...
// Cache for lyrics to keep them loaded across player screen open/close
final cachedLyricsProvider = StateProvider<Lyrics?>((ref) => null);
final cachedLyricsTitleProvider = StateProvider<String?>((ref) => null);
